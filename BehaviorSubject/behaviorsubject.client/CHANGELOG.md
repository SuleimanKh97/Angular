...
- Create Angular project with ng: `ng new behaviorsubject.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`behaviorsubject.client.esproj`).
